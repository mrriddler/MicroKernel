...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MicroKernel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11MicroKernel25MicroKernelViewController")
@interface MicroKernelViewController : UIViewController
...
SWIFT_CLASS("_TtC11MicroKernel23PlatformMainApplication")
@interface PlatformMainApplication : UIResponder <UIApplicationDelegate>
